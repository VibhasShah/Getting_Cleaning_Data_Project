# Data files are availale in the current directory as specified below

setwd("C:\\Vibhas\\Coursera Certifications\\3 - Getting and Cleaning Data\\Homework\\Project\\UCI HAR Dataset")
